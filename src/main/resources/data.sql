...
INSERT INTO gos (session_id, boulder_id, result, timestamp) VALUES
    -- Gos for alice's first session (session_id = 1, gym 1)
    ...
    -- Gos for alice's second session (session_id = 2, gym 1)
    ...
    -- Gos for alice's third session (session_id = 3, gym 2)
    ...
    -- Gos for bob's first session (session_id = 4, gym 2)
    ...
    -- Gos for bob's second session (session_id = 5, gym 3)
