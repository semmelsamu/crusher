 ...
 * <p>
 * Maps to the {@code sessions} table and stores the session timing (started and ended timestamps)
 * along with references to the user who created the session and the gym where it took place.
 * </p>
 */
@Entity
@Table(name = "sessions")
public class SessionEntity {
    ...
    public SessionEntity(LocalDateTime startedAt, LocalDateTime endedAt, UserEntity user, GymEntity gym) {
