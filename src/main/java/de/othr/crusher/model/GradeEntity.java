 ...
 *
 * <p>Stores human-readable identifiers (name), along with scale values (V-scale and Font-scale) and
 * an optional description. Each grade belongs to exactly one gym.
 */
@Entity
@Table(name = "grades")
public class GradeEntity {
  ...
  public GradeEntity(
      String name, String vScale, String fontScale, String description, GymEntity gym) {
    this.name = name;
    this.vScale = vScale;
