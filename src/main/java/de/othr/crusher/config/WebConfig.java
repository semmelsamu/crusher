...
public class WebConfig implements WebMvcConfigurer {
  ...
  /**
   * Exposes uploaded assets under /uploads/** by mapping the configured upload directory as a
  ...
  /**
   * Registers a HiddenHttpMethodFilter, enabling support for HTTP methods like PUT and DELETE via
