 ...
 *
 * <p>Implements the {@link UserDetailsService} interface and retrieves user information from the
 * database using the {@link UserRepository}.
 *
 * <p>This service is used by Spring Security to authenticate users based on their username. It
 * fetches the user entity from the database, converts it into a {@link UserDetails} instance, and
 * provides Spring Security with the user’s credentials and roles.
 */
@Service
