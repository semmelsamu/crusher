...
public interface BoulderRepository extends JpaRepository<BoulderEntity, Long> {
   ...
   */
  Page<BoulderEntity> findBySectorGymIdAndGradeIdIn(
      Long gymId, List<Long> gradeIds, Pageable pageable);
   ...
   */
  Page<BoulderEntity> findBySectorIdAndGradeIdIn(
      Long sectorId, List<Long> gradeIds, Pageable pageable);
   ...
   */
  Page<BoulderEntity> findBySectorGymIdAndGradeIdInAndDeletedFalse(
      Long gymId, List<Long> gradeIds, Pageable pageable);
   ...
   */
  Page<BoulderEntity> findBySectorIdAndGradeIdInAndDeletedFalse(
      Long sectorId, List<Long> gradeIds, Pageable pageable);
   ...
   */
  Page<BoulderEntity> findBySectorIdAndIdInAndDeletedFalse(
      Long sectorId, List<Long> ids, Pageable pageable);
  ...
  List<BoulderEntity> findBySectorIdAndGradeIdInAndIdInAndDeletedFalse(
      Long sectorId, List<Long> gradeIds, List<Long> ids);
  ...
  Page<BoulderEntity> findBySectorIdAndGradeIdInAndIdInAndDeletedFalse(
      Long sectorId, List<Long> gradeIds, List<Long> ids, Pageable pageable);
   ...
   */
  Page<BoulderEntity> findBySectorGymIdAndIdInAndDeletedFalse(
      Long gymId, List<Long> ids, Pageable pageable);
  ...
  List<BoulderEntity> findBySectorGymIdAndGradeIdInAndIdInAndDeletedFalse(
      Long gymId, List<Long> gradeIds, List<Long> ids);
  ...
  Page<BoulderEntity> findBySectorGymIdAndGradeIdInAndIdInAndDeletedFalse(
      Long gymId, List<Long> gradeIds, List<Long> ids, Pageable pageable);
