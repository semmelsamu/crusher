...
/**
 * Controller for managing event ratings. Provides endpoints for creating and updating user ratings
 * for events.
 */
@Controller
public class EventRatingController {
  ...
  /**
   * Creates or updates a rating for an event. This endpoint is idempotent - it will create a new
  ...
  public String setRating(
    ...
    EventRatingEntity ratingEntity =
        ratingRepository
