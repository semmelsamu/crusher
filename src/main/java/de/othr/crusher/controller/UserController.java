...
/**
 * Controller for managing users. Provides endpoints for listing users and editing user accounts.
 */
@Controller
...
public class UserController {
  ...
  /**
   * Displays the edit form for a specific user. Users can edit their own account, admins can edit
   * any user.
   *
  ...
  /**
   * Updates a user. Regular users can update their own username and email. Admins can update any
   * user's username, email, and role.
   *
  ...
  /**
   * Deletes a user account (soft delete). Users can delete their own account, admins can delete any
   * user.
   *
  ...
  private boolean isAdmin(Principal principal) {
    ...
    UserEntity user = userRepository.findByNameAndDeletedFalse(principal.getName()).orElse(null);
  ...
  /**
   * Checks if the current user can edit the specified user. Users can edit themselves, admins can
   * edit anyone.
   *
   * @param principal the authenticated user principal
  ...
  private String resolveReturnTo(String returnTo, HttpServletRequest request, boolean isAdmin) {
    ...
    if (!StringUtils.hasText(resolved)
        || resolved.startsWith("/users/") && resolved.endsWith("/edit")) {
