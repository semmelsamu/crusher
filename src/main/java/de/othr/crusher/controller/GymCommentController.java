...
/**
 * Controller for managing gym comments.
 * Provides endpoints for creating user comments on gyms.
 */
@Controller
public class GymCommentController {
    ...
    public String deleteComment(
        ...
        if (!comment.getGym().getId().equals(gymId)) {
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Comment does not belong to this gym");
        }
