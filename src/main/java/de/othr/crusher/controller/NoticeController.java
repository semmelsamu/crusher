...
public class NoticeController {
  ...
  public String showEditForm(
      @PathVariable("gymId") long gymId, @PathVariable("noticeId") long noticeId, Model model) {
  ...
  /**
   * Handles the creation of a new notice. Validates input and either redisplays the form with
   * errors or saves the new notice.
   *
   * @param gymId identifier of the parent gym
  ...
  /**
   * Updates an existing notice. Validates input and either redisplays the form with errors or saves
   * the changes.
   *
   * @param gymId identifier of the parent gym
   * @param noticeId identifier of the notice
  ...
  private NoticeEntity findNoticeInGymOrThrow(long gymId, long noticeId) {
    ...
    if (notice.getGym() == null
        || notice.getGym().getId() == null
