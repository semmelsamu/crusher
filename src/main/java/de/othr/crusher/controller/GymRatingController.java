...
/**
 * Controller for managing gym ratings. Provides endpoints for creating and updating user ratings
 * for gyms.
 */
@Controller
public class GymRatingController {
  ...
  /**
   * Creates or updates a rating for a gym. This endpoint is idempotent - it will create a new
  ...
  public String setRating(
    ...
    GymRatingEntity ratingEntity =
        ratingRepository.findByUserIdAndGymId(user.getId(), gymId).orElse(new GymRatingEntity());
