...
/**
 * Controller for managing event comments. Provides endpoints for creating user comments on events.
 */
@Controller
public class EventCommentController {
  ...
  public String deleteComment(
    ...
    if (!comment.getEvent().getId().equals(eventId)
      ...
      throw new ResponseStatusException(
          HttpStatus.BAD_REQUEST, "Comment does not belong to this event");
    }
