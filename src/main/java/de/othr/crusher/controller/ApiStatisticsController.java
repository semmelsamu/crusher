...
/**
 * REST controller for the statistics API.
 * Provides endpoints to configure and retrieve user climbing statistics.
 */
@RestController
...
public class ApiStatisticsController {
     ...
     * Only returns data since the last fetch, then updates the lastFetchedAt timestamp.
     */
    @GetMapping
    @Transactional
