...
public class ProjectController {
  ...
  /**
   * Toggles the project state for the current user on a given boulder. Adds the project when
   * missing, removes it when present.
   *
  ...
  public String toggleProject(
    ...
    boolean nowActive =
        projectRepository.findByUserIdAndBoulderId(user.getId(), boulderId).isPresent();
    redirectAttributes.addFlashAttribute(
        ...
        Map.of(
            ...
            "success",
            "message",
            nowActive ? "Boulder added to your projects!" : "Boulder removed from your projects."));
  ...
  /**
   * Marks a boulder as a project for the current user. Idempotent: adding an existing project is
   * treated as success without error.
   *
   * @param boulderId identifier of the boulder
   * @param gymId optional gym filter to preserve on redirect
   * @param sectorId optional sector filter to preserve on redirect
  ...
  /**
   * Removes a boulder from the current user's projects. Idempotent: removing a missing project is
   * treated as success without error.
   *
   * @param boulderId identifier of the boulder
   * @param gymId optional gym filter to preserve on redirect
