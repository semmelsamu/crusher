...
public class ApiUserController {
  ...
  public ResponseEntity<?> createUser(
      @RequestBody(required = false) CreateUserRequest request, Authentication authentication) {
    if (request == null) {
  ...
  public ResponseEntity<?> updateUser(
    ...
    return updateUser(
        user, request, privileged, currentUser.getId().equals(id) ? httpRequest : null);
  }
