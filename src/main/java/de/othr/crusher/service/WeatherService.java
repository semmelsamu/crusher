...
/**
 * Service for fetching weather information for gym locations.
 * Uses Open-Meteo API to get current weather conditions.
 */
@Service
public class WeatherService {
    ...
    /**
     * Maps WMO Weather Code to WeatherInfo with text and icon.
