...
public class SectorImageStorageService {
  ...
  /**
   * Creates a storage service for sector images. Ensures the upload root exists and reads size
  ...
  /**
   * Resolves a stored image path on disk, ensuring it is within the configured uploads directory to
