 ...
 * <p>
 * Implements {@link CommandLineRunner} and runs once when the Spring Boot application
 * starts. It retrieves all users from the database and encodes any plaintext passwords
 * using the provided {@link PasswordEncoder}.
 * </p>
 * <p>
 * This ensures that passwords stored in the database are always securely encoded,
 * even if inserted in plaintext via a SQL script.
 * </p>
 */
@Component
public class PasswordEncoderRunner implements CommandLineRunner {
     ...
     * <p>
     * Queries all users and checks if the password is already encoded. If not,
     * it encodes the password using {@link PasswordEncoder} and updates the database.
     * </p>
     *
